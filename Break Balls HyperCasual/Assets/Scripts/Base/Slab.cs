...
public class Slab : ObstacleManager
{
    ...
    private void Update()
    {
        if (!isShattered)
        {
            ...
            {
                Slab nextSlab = rightSideSupport.GetComponent<Slab>();
                ...
                for (int i = 0; i < 15; i++)
                {
                    ...
                    {
                        nextSlab = nextSlab.rightSideSupport.GetComponent<Slab>();
            ...
            {
                Slab prevSlab = leftSideSupport.GetComponent<Slab>();
                ...
                for (int i = 0; i < 15; i++)
                {
                    ...
                    {
                        prevSlab = prevSlab.leftSideSupport.GetComponent<Slab>();
